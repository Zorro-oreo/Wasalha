...
import { seedDefaultMethods } from "../../db/payments";
...
const passwordStrengthCheck = (
  pass: string,
): { score: number; label: string; color: string; hint: string } => {
  ...
  if (pass.includes(" ") || pass.length < MIN_PASSWORD_LENGTH) {
    return {
      ...
      label: "Weak",
      color: "#D64545",
      hint: `Use at least ${MIN_PASSWORD_LENGTH} characters with no spaces`,
    };
  }
  ...
  if (hasUpper || hasSpecial) {
    return {
      ...
      color: "#3B82F6",
      hint: hasUpper
        ? `Add a special character for stronger password`
        : `Add an uppercase letter for stronger password`,
    };
  }
  return {
    score: 2,
    label: "Fair",
    color: "#F59E0B",
    hint: `Add uppercase letters or special characters to strengthen it`,
  };
};
...
export default function UserAuthScreen() {
  ...
  const handleSignUp = async (data: SignUpForm) => {
    ...
    try {
      ...
      await seedDefaultMethods(db, id);
        ...
        switch (selectedIndex) {
          case 0: // Photo Library
            ...
            if (!libResult.canceled) {
              signUpSetValue("officialIdUri", libResult.assets[0].uri, {
                shouldValidate: true,
                shouldDirty: true,
              });
          ...
          case 1: // Take Photo
            ...
            if (!camResult.canceled) {
              signUpSetValue("officialIdUri", camResult.assets[0].uri, {
                shouldValidate: true,
                shouldDirty: true,
              });
              signUpClearErrors("officialIdUri");
          ...
          case 2: // Choose file
            ...
            if (!fileResult.canceled) {
              signUpSetValue("officialIdUri", fileResult.assets[0].uri, {
                shouldValidate: true,
                shouldDirty: true,
              });
              signUpClearErrors("officialIdUri");
  ...
  const datePicker = (event: any, selectedDate?: Date) => {
    ...
    setDate(currentDate);
    signUpSetValue("birthdate", formatDate(currentDate), {
      shouldValidate: true,
      shouldDirty: true,
    });
            ...
            <SafeAreaView style={styles.titleContainer} edges={["top"]}>
              <View style={styles.headerContent}>
                ...
                <View
                  style={{
                    ...styles.outerPill,
                    marginTop: activeTab === "signin" ? 22 : 45,
                  }}
                >
                  <Animated.View
                    style={[
                      styles.slidingPill,
                      { left: slideX, width: slideWidth },
                    ]}
                  />
                  <TouchableOpacity
                    style={styles.tab}
                    onLayout={onSignInLayout}
                    onPress={() => handleSwitch("signin")}
                  >
                    <Text
                      style={[
                        styles.tabText,
              ...
              <View style={{ flex: 1 }}>
                ...
                <Animated.ScrollView
                  ...
                  style={[
                    styles.signUpScrollLayer,
                    {
                      opacity: signUpOpacity,
                      zIndex: activeTab === "signup" ? 2 : 1,
                    },
                  ]}
                  contentContainerStyle={[
                    styles.signUpScrollContent,
                    { paddingTop: 65 },
                  ]}
                ...
                >
                  <View>
                    ...
                    <View style={{ ...styles.fieldContainer, paddingTop: 20 }}>
                      {generalError ? (
                        <Text style={styles.fieldErrorSlot}>
                          {generalError}
                        </Text>
                      ) : null}
                      {signUpErrors.fname && (
                        <Text style={styles.fieldErrorSlot}>
                          {signUpErrors.fname?.message}
                        </Text>
                      )}
                      <Controller
                        control={signUpControl}
                          ...
                          <View
                            style={[
                              styles.pickers,
                              {
                                ...
                                width: "100%",
                                flexDirection: "row",
                                borderColor: signUpErrors.birthdate
                                  ? "#D64545"
                                  : "#CECCD6",
                                borderWidth: 1,
                              },
                      ...
                      <View style={{ width: "48%" }}>
                        ...
                        <TouchableOpacity onPress={imagePicker}>
                          <View
                            style={[
                              styles.pickers,
                              {
                                ...
                                width: "100%",
                                flexDirection: "row",
                                borderColor: signUpErrors.officialIdUri
                                  ? "#D64545"
                                  : "#CECCD6",
                                borderWidth: 1,
                              },
                          ...
                          >
                            ...
                            <Ionicons
                              name={
                                officialIdUri ? "checkmark-circle" : "image"
                              }
                              size={20}
                              color={officialIdUri ? "#B85A9A" : "#8A84CE"}
                              style={{ alignSelf: "center" }}
                            />
                          </View>
                        </TouchableOpacity>
                    ...
                    <View style={styles.fieldContainer}>
                      ...
                      >
                        ...
                        >
                          <Ionicons
                            name={isSignUpPasswordVisible ? "eye-off" : "eye"}
                            size={24}
                            color="#8A84CE"
                          />
                        </TouchableOpacity>
                    ...
                    >
                      ...
                      <Text style={styles.ApButtonText}>
                        Continue with Apple
                      </Text>
                    </TouchableOpacity>
                ...
                <Animated.ScrollView
                  ...
                  style={[
                    styles.signInScrollLayer,
                    {
                      opacity: signInOpacity,
                      zIndex: activeTab === "signin" ? 2 : 1,
                    },
                  ]}
                  contentContainerStyle={[
                    styles.signInScrollContent,
                    { paddingTop: 65 },
                  ]}
                  showsVerticalScrollIndicator={false}
                  keyboardShouldPersistTaps="handled"
